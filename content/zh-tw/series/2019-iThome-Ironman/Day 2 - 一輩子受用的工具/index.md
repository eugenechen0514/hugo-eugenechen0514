...
1. 輸入 `pwd` 可以知道當前資料夾是在哪，指令的預設目錄是這裡
  ![Screen Shot 2018-10-02 at 7.16.33 PM.png](resources/663BBF25EFB72D419E9BC9F56EE51456.png =360x66)
1. `mkdir src` 就會建立src資料夾
![Screen Shot 2018-10-02 at 7.19.03 PM.png](resources/ECE4E0737AAC33CB0307D2DFC474122D.png =314x153)
1. `touch README.md` 建立空的README.md
![Screen Shot 2018-10-02 at 7.20.41 PM.png](resources/D1D8BBE98AEF4375FAC4FA897E8A3BD6.png =309x148)
1. `cp README.md src` 拷貝README.md到src資料夾
![Screen Shot 2018-10-02 at 7.22.46 PM.png](resources/952B083CD100289FC616FFAA0807ADAE.png =328x217)
1. `cd src` 移動當前資料夾到src，你可以再輸入`pwd`看看當前資料夾是不是變了
![Screen Shot 2018-10-02 at 7.26.05 PM.png](resources/584320F5D84ABE513D180E1E53D12943.png =360x65)
1. `rm README.md` 刪除README.md
![Screen Shot 2018-10-02 at 7.27.06 PM.png](resources/40965BA4EB29A4225C1E02F7EFC31722.png =310x193)
1. `cd ..` 回到上一層資料夾。這裡的相對路徑中，`..` 指上一層資料夾，`.`指當前資料夾
1. `ls -l`
![Screen Shot 2018-10-02 at 7.54.20 PM.png](resources/82A930179714CB499F67475D3547DB9B.png =445x67)
...
![Screen Shot 2018-10-02 at 7.42.33 PM.png](resources/8C5CBB6F79F3598B7AFE342F530F5323.png =663x168)
...
![Screen Shot 2018-10-02 at 9.42.52 PM.png](resources/262125395E6DF8B13A34C9511B5080D9.png =230x152)
...
Markdown 文字：
![Screen Shot 2018-10-02 at 10.01.30 PM.png](resources/8FA9B16D41E3959F63C7AE9A52BE463C.png =857x286)

檢視結果如下：
![Screen Shot 2018-10-02 at 10.00.33 PM.png](resources/55D65C81FB7C80660B52918D63024193.png =546x439)
...
1. 格式語法風格不容易統一
1. 圖片/檔案資源一般不會放在文件內，要用外部資源，以圖片為例：`![圖片無法顯示時文字](URI資源)`。不過，還是可以用[base64 image](https://www.base64-image.de/)文字，把圖片轉成文字再鑲入文件中，但你不會想這麼做的，下面就是一張圖片：![Screen Shot 2018-10-03 at 9.04.20 AM.png](resources/3C805EBD6971FD583158455B47EFD5F7.png =9x12)。此外，檢視軟體能不能解讀又是另一回事，我用的筆記軟體  [Quiver](https://itunes.apple.com/app/quiver-programmers-notebook/id866773894?ls=1&mt=12)和 VSCode - Markdown All in One 剛好都可以解讀。
    ```
...
![Screen Shot 2018-09-18 at 7.38.24 PM.png](resources/433647A473DC15C4BF3A28D2B2CDA911.png =513x145)
1. 搜尋 `markdown`，你會看到一堆可以選，基本上有`Preview`的都可以用
![Screen Shot 2018-09-18 at 7.38.40 PM.png](resources/A401B37AC8DD889A088D54067C40199C.png =371x741)
1. 我是選擇下載人數多的 `Markdown All in One`
![Screen Shot 2018-09-18 at 7.39.21 PM.png](resources/2D30640CF28DE0A6F8F4F5741EE3D83B.png =912x338)
1. 在Markdown文件中，開啟Priview
![D781E0D8C235C5E84A2BEA3DFA5DE460.png](resources/79E26D03ED3EF11F2A7D1A5FBA8DB1B3.png =1077x208)
![Screen Shot 2018-09-18 at 7.43.18 PM.png](resources/1F3F6A33E7B9ABEB42949B6D4EFFE57C.png =867x288)
...
![Screen Shot 2018-10-02 at 10.27.03 PM.png](resources/9EE170E322824E279F17FC1AC90E53DF.png =556x632)
